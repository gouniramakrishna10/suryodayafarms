  ...
  try {
    ...
    if (gallery.length === 0) {
      ...
      const mockGallery = [
        ...
        { id: '2', title: 'Handpicked Organic Carrots', category: 'Products', image: 'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?auto=format&fit=crop&q=80&w=1200', description: 'Freshly harvested heirloom orange carrots covered in nutritious, pesticide-free soil.' },
        ...
        { id: '5', title: 'Cold Churning A2 Ghee', category: 'Products', image: 'https://images.unsplash.com/photo-1588166524941-3bf61a9c41db?auto=format&fit=crop&q=80&w=1200', description: 'Clarifying organic butter over a slow wooden-fueled fire inside our Vedic kitchens.' },
