...
async function enrichMint() {
  console.log('--- ENRICHING EXISTING MINT LEAF POWDER PRODUCT ---');

  // 1. Locate existing product in DB
  const targetProduct = await prisma.product.findFirst({
    where: {
      OR: [
        { name: { contains: 'Mint', mode: 'insensitive' } }
      ]
    },
    include: {
      categories: true,
  ...
  if (!targetProduct) {
    console.error('❌ Target Mint Leaf Powder product not found in database.');
    process.exit(1);
  }
  ...
  const contentSections = [
    {
      ...
      content: {
        ...
        tagline: 'Refreshing Nature. Everyday Wellness.',
    ...
    },
    {
      ...
      title: 'Why Choose Suryodaya Farms Mint Leaf Powder?',
      content: {
        title: 'Why Choose Suryodaya Farms Mint Leaf Powder?',
        cards: [
          {
            icon: '🍃',
            title: 'Carefully Selected Mint Leaves',
            description: 'Prepared from carefully selected mint leaves that meet our quality standards.'
          },
          {
            icon: '🔬',
          ...
          },
          {
            ...
            description: 'Packed in high-quality food-grade packaging designed to help preserve freshness, natural aroma, and product quality.'
          },
          {
            icon: '💚',
    ...
    },
    {
      ...
      content: {
        title: 'Naturally Occurring Nutrients',
        items: [
          { name: 'Vitamins', value: 'Essential Vitamins A & C' },
          { name: 'Minerals', value: 'Iron, Potassium & Calcium' },
          { name: 'Dietary Fibre', value: 'Digestive Ease' },
          { name: 'Plant-Based Compounds', value: 'Menthol & Phytonutrients' },
    ...
    },
    {
      ...
      content: {
        title: 'Ways to Enjoy',
        recipes: [
          { icon: '🥤', title: 'Smoothies & Health Drinks', description: 'Blend into green smoothies, mint coolers, and fruit shakes.' },
          { icon: '🍵', title: 'Warm Water & Herbal Beverages', description: 'Stir into warm water or green tea for a soothing mint infusion.' },
          { icon: '🍲', title: 'Soups', description: 'Add a pinch to lentil, pea, or vegetable soups for fresh herbal aroma.' },
          { icon: '🥗', title: 'Salads', description: 'Sprinkle over fresh cucumber, watermelon, and garden salads.' },
          { icon: '🥣', title: 'Chutneys & Dips', description: 'Mix into pudina chutney, coriander dip, and raita.' },
          { icon: '🥛', title: 'Yogurt & Buttermilk', description: 'Whisk into spiced buttermilk (chaas), lassi, and fresh curd.' },
          { icon: '🍹', title: 'Refreshing Drinks', description: 'Stir into lemonade, jaljeera, mocktails, and iced teas.' },
          { icon: '🍢', title: 'Marinades & Everyday Recipes', description: 'Use in marinades, kebabs, rice dishes, and savory snacks.' }
        ]
      },
      orderIndex: 5,
      isVisible: true
    ...
    },
    {
      ...
      content: {
        title: 'Ingredients Breakdown',
        html: '<p><strong>100% Mint Leaf Powder</strong></p><p>Nothing Added. Nothing Removed. Just Carefully Prepared Mint Leaves.</p>'
      },
      orderIndex: 8,
      isVisible: true
    },
    ...
    },
    {
      ...
      content: {
        ...
        items: [
          {
            question: 'Is this made from 100% mint leaves?',
            answer: 'Yes. Our product contains only 100% Mint Leaf Powder.'
          },
          {
            question: 'How can I use it?',
            answer: 'It can be added to beverages, smoothies, chutneys, soups, salads, yogurt, buttermilk, marinades, and many everyday recipes.'
          },
          {
    ...
    },
    {
      ...
      content: {
        title: 'Our Promise',
        html: '<p>Every pack of Suryodaya Farms Mint Leaf Powder reflects our dedication to quality, scientific responsibility, and customer trust.</p><p>We continuously improve our products because we believe our customers deserve safe, consistent, and reliable quality with every purchase.</p>'
      },
      orderIndex: 12,
      isVisible: true
    },
  ...
  const shortDescription = '100% Pure Mint Leaf (Mentha spp.) Powder. Science-guided dried & processed, rich in natural menthol aroma, antioxidants & digestion-soothing compounds.';
  ...
  const updatedProduct = await prisma.product.update({
    ...
    data: {
      ...
      seoTitle: 'Mint Leaf Powder (100% Pure Pudina Powder) | Suryodaya Farms',
      seoDescription: 'Buy 100% Pure Mint Leaf (Pudina) Powder. Gently dried, aromatic mint leaves rich in antioxidants for chutneys, buttermilk, raita, teas & mocktails.',
  ...
  console.log('\n✅ MINT LEAF POWDER ENRICHED SUCCESSFULLY IN DATABASE!');
  ...
  console.log('\n--- ALL MINT ENRICHMENT CHECKS PASSED PERFECTLY! ---');
}
