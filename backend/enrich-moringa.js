...
async function enrichMoringa() {
  console.log('--- ENRICHING EXISTING MORINGA LEAF POWDER PRODUCT ---');

  // 1. Locate existing product in DB
  const targetProduct = await prisma.product.findFirst({
    where: {
      OR: [
        { name: { contains: 'Moringa', mode: 'insensitive' } }
      ]
    },
    include: {
      categories: true,
  ...
  if (!targetProduct) {
    console.error('❌ Target Moringa Leaf Powder product not found in database.');
    process.exit(1);
  }
  ...
  const contentSections = [
    {
      ...
      title: 'Hero Overview',
      content: {
        collectionName: 'Nature\'s Everyday Nutrition',
        tagline: 'Nature\'s Everyday Nutrition for a Balanced Lifestyle.',
        intro: 'At Suryodaya Farms, we believe that nature offers some of the finest ingredients for a balanced lifestyle. Our Moringa Leaf Powder is prepared from carefully selected moringa leaves using quality-focused processing practices designed to help preserve their natural colour, freshness, and nutritional value.'
      },
      orderIndex: 0,
      isVisible: true
    },
    ...
    },
    {
      ...
      title: 'Why Choose Suryodaya Farms Moringa Leaf Powder?',
      content: {
        title: 'Why Choose Suryodaya Farms Moringa Leaf Powder?',
        cards: [
          {
            icon: '🌿',
            title: 'Carefully Selected Leaves',
            description: 'Prepared from carefully selected moringa leaves that meet our quality standards.'
          },
          {
            icon: '🔬',
            title: 'Science-Guided Product Development',
            description: 'Developed using scientific knowledge to support consistent product quality and continuous improvement.'
          },
          {
            icon: '🏆',
            title: 'Quality Without Compromise',
            description: 'Quality is considered throughout ingredient selection, processing, packaging, and storage.'
          },
          {
            icon: '✨',
            title: 'Hygienically Processed',
            description: 'Prepared using hygienic handling and responsible processing practices.'
          },
          {
            icon: '🛍️',
            title: 'Carefully Packed',
            description: 'Packed in food-grade packaging to help protect freshness, quality, and product integrity.'
          },
          {
            icon: '💚',
            title: 'A Brand You Can Trust',
            description: 'Every product reflects the values that define Suryodaya Farms—quality, integrity, transparency, and customer confidence.'
          }
        ]
      },
      orderIndex: 2,
    ...
    },
    {
      ...
      content: {
        title: 'Naturally Occurring Nutrients',
        items: [
          { name: 'Vitamins', value: 'Rich Essential Vitamins' },
          { name: 'Minerals', value: 'Iron, Calcium & Potassium' },
          { name: 'Plant Protein', value: 'Natural Amino Acids' },
          { name: 'Dietary Fibre', value: 'Digestive Ease' },
          { name: 'Naturally Occurring Antioxidants', value: 'Phytonutrient Support' }
        ]
      },
      orderIndex: 4,
      isVisible: true
    },
    {
      ...
      content: {
        title: 'Ways to Enjoy',
        recipes: [
          { icon: '🥛', title: 'Mix into Milk', description: 'Stir a spoonful into warm or golden milk for wholesome plant nutrition.' },
          { icon: '🥤', title: 'Blend into Smoothies', description: 'Blend into green smoothies, fruit shakes, and fitness drinks.' },
          { icon: '💧', title: 'Stir into Warm Water', description: 'Whisk into warm water with honey for a refreshing morning drink.' },
          { icon: '🍲', title: 'Add to Soups', description: 'Stir into warm vegetable and lentil soups for an extra nutrient boost.' },
          { icon: '🥗', title: 'Sprinkle over Salads', description: 'Dust over fresh green salads, grain bowls, and sprouts.' },
          { icon: '🍛', title: 'Mix into Dal or Curries', description: 'Incorporate into daily lentil dals, sambar, and Indian curries.' },
          { icon: '🍳', title: 'Healthy Recipes', description: 'Add to omelets, paratha dough, and wholesome baked goods.' }
        ]
      },
      orderIndex: 5,
      isVisible: true
    },
    {
      ...
      content: {
        title: 'Suggested Serving',
        items: [
          'Consume according to your individual dietary needs and preferences.',
          'If you are pregnant, breastfeeding, taking medication, or under medical supervision, consult a qualified healthcare professional before making significant dietary changes.'
        ]
      },
      orderIndex: 6,
      isVisible: true
    ...
    },
    {
      ...
      content: {
        title: 'Packaging Information',
        items: [
          'Packed in food-grade packaging designed to help protect freshness, quality, and product integrity.'
        ]
      },
      orderIndex: 9,
      isVisible: true
      ...
      content: {
        ...
        items: [
          ...
          },
          {
            ...
            answer: 'Yes. It can be incorporated into a variety of foods and beverages according to your personal preferences.'
          },
          {
            question: 'How should I store it?',
            answer: 'Store in a cool, dry place, keep the pack tightly closed, and always use a clean, dry spoon.'
          },
          {
    ...
    },
    {
      ...
      content: {
        title: 'Our Promise',
        html: '<p>Every pack of Suryodaya Farms Moringa Leaf Powder reflects our commitment to quality, integrity, scientific responsibility, and customer trust.</p><p>We continuously improve our products because we believe our customers deserve consistent quality, honest communication, and thoughtful care.</p><p>From carefully selected leaves to thoughtfully prepared nutrition, every pack represents our promise of purity, quality, and trust.</p>'
      },
      orderIndex: 12,
      isVisible: true
    },
    {
      ...
      content: {
        title: 'The Suryodaya Difference',
        html: '<p>At Suryodaya Farms, quality is not something added at the end—it is built into every step of the journey. From carefully selecting ingredients and following responsible processing practices to hygienic packaging and continuous improvement, every decision is guided by our commitment to excellence.</p><p>Every product we create reflects our dedication to quality, integrity, transparency, and the trust our customers place in us.</p><p><strong>Suryodaya Farms: Pure by Nature. Guided by Science. Trusted for Quality.</strong></p>'
      },
      orderIndex: 13,
      isVisible: true
    }
  ...
  console.log('\n✅ MORINGA LEAF POWDER ENRICHED SUCCESSFULLY IN DATABASE!');
  ...
  console.log('\n--- ALL MORINGA ENRICHMENT CHECKS PASSED PERFECTLY! ---');
}
