...
async function enrichCurryLeaf() {
  console.log('--- ENRICHING EXISTING CURRY LEAF POWDER PRODUCT ---');

  // 1. Locate existing product in DB
  const targetProduct = await prisma.product.findFirst({
    where: {
      OR: [
        { name: { contains: 'Curry Leaf', mode: 'insensitive' } },
  ...
  if (!targetProduct) {
    console.error('❌ Target Curry Leaf Powder product not found in database.');
    process.exit(1);
  }
  ...
  const contentSections = [
    {
      ...
      content: {
        ...
        tagline: 'The Aroma of Tradition. The Goodness of Nature.',
        intro: 'At Suryodaya Farms, we believe that some of nature\'s finest ingredients are those treasured in traditional kitchens for generations. Our Curry Leaf Powder is prepared from carefully selected curry leaves using quality-focused processing practices designed to help preserve their natural aroma, vibrant colour, and nutritional value.'
      },
      orderIndex: 0,
      isVisible: true
    },
    ...
    },
    {
      ...
      title: 'Why Choose Suryodaya Farms Curry Leaf Powder?',
      content: {
        title: 'Why Choose Suryodaya Farms Curry Leaf Powder?',
        cards: [
          {
            icon: '🍃',
            title: 'Carefully Selected Curry Leaves',
            description: 'Prepared from carefully selected curry leaves that meet our quality standards.'
          },
          {
            icon: '🔬',
          ...
          },
          {
            ...
            description: 'Every product reflects the values that define Suryodaya Farms: Nature • Science • Quality • Trust.'
          }
        ]
      },
      orderIndex: 2,
    ...
    },
    {
      ...
      content: {
        title: 'Naturally Occurring Nutrients',
        items: [
          { name: 'Vitamins', value: 'Vitamins A, B, C & E' },
          { name: 'Minerals', value: 'Iron, Calcium & Phosphorus' },
          { name: 'Dietary Fibre', value: 'Digestive Ease' },
          { name: 'Plant-Based Compounds', value: 'Carbazole Alkaloids' },
    ...
    },
    {
      ...
      content: {
        title: 'Ways to Enjoy',
        recipes: [
          { icon: '🍚', title: 'Sprinkle over Rice', description: 'Dust over warm steamed rice with a drizzle of ghee or sesame oil.' },
          { icon: '🍛', title: 'Mix into Curries', description: 'Stir into Indian curries, korma, and gravies for traditional aroma.' },
          { icon: '🍲', title: 'Add to Dals', description: 'Whisk into daily lentil dals, rasam, and sambar.' },
          { icon: '🥣', title: 'Blend into Chutneys', description: 'Blend with roasted gram, coconut, or peanuts for authentic curry leaf chutney.' },
          { icon: '🍵', title: 'Stir into Soups', description: 'Add a pinch to vegetable soups and herbal clear broths.' },
          { icon: '🥦', title: 'Season Vegetables', description: 'Toss over sautéed vegetables, poriyal, and stir-fries.' },
          { icon: '🍳', title: 'Healthy Recipes', description: 'Mix into upma, dosa batter, and savory breakfast snacks.' }
        ]
      },
      orderIndex: 5,
      isVisible: true
    },
    {
      ...
      content: {
        title: 'Suggested Serving',
        items: [
          'Use according to your individual taste and dietary preferences as part of a balanced diet.',
      ...
      content: {
        ...
        items: [
          ...
          },
          {
            ...
            answer: 'It can be added to rice, curries, dals, soups, chutneys, vegetables, and many everyday recipes.'
          },
          {
    ...
    },
    {
      ...
      content: {
        title: 'Our Promise',
        html: '<p>Every pack of Suryodaya Farms Curry Leaf Powder reflects our commitment to quality, integrity, scientific responsibility, and customer trust.</p><p>We continuously improve our products because we believe our customers deserve consistent quality, honest communication, and thoughtful care.</p><p>From carefully selected leaves to thoughtfully prepared nutrition, every pack represents our promise of purity, quality, and trust.</p>'
      },
      orderIndex: 12,
      isVisible: true
    },
  ...
  const updatedProduct = await prisma.product.update({
    ...
    data: {
      ...
      productType: 'Dehydrated Culinary Herb Powder',
  ...
  console.log('\n✅ CURRY LEAF POWDER ENRICHED SUCCESSFULLY IN DATABASE!');
  ...
  console.log('\n--- ALL CURRY LEAF ENRICHMENT CHECKS PASSED PERFECTLY! ---');
}
